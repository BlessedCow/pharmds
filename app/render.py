...
PD_EFFECT_STYLES: dict[str, str] = {
    ...
    "sympathomimetic_activity": "bright_blue",
    "blood_pressure_increase": "bright_red",
    "tachycardia_risk": "bright_red",
    "hypertension_risk": "bright_red",
    "hypokalemia_risk": "yellow",
    "hyperkalemia_risk": "yellow",
    "urinary_retention_risk": "bright_magenta",
    "photosensitivity_risk": "bright_yellow",
    "intracranial_hypertension_risk": "bright_red",
    "hypersensitivity_risk": "bright_red",
    "neurotoxicity_risk": "bright_red",
